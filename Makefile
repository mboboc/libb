...
SOURCE5 = ft_atoi.c ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c 
SOURCE6 = ft_isprint.c ft_toupper.c ft_tolower.c
all:
	gcc main.c $(SOURCE1) $(SOURCE2) $(SOURCE3) $(SOURCE4)  $(SOURCE5) $(SOURCE6) -Wall
clean:
	rm a.out
